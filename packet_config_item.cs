...
namespace BlueCgProcessMonitor
{
    ...
    public class PacketConfigManager
    {
        ...
        private System.Threading.Timer executeTimer;
        ...
        {
            executeTimer = new System.Threading.Timer(ExecuteCallback, null, 0, 100);
        }
